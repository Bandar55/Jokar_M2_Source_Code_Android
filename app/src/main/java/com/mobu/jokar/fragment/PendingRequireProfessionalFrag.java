 ...
 */
public class PendingRequireProfessionalFrag extends Fragment {
    private PendingRequireProfessionalAdapter requireAdapter;
    ...
    public PendingRequireProfessionalFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        requireAdapter = new PendingRequireProfessionalAdapter(getActivity(), pendingList);
    ...
    private void allClick() {
        ...
        requireAdapter.setListener(new PendingRequireProfessionalAdapter.ViewOffersInterface() {
            @Override
