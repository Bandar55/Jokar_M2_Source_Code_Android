...
import com.mobu.jokar.adapter.NUPendingProfessionalWorkerAdapter;
...
public class NUPendingProfessionalWorkerFrag extends Fragment {
    ...
    private NUPendingProfessionalWorkerAdapter requireAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        requireAdapter = new NUPendingProfessionalWorkerAdapter(getActivity(), pendingList);
    ...
    private void allClick() {
        ...
        requireAdapter.setListener(new NUPendingProfessionalWorkerAdapter.ViewOffersInterface() {
            @Override
