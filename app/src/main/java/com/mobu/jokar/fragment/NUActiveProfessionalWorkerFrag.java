...
import com.mobu.jokar.adapter.NUActiveProWorkerAdapter;
 ...
 */
public class NUActiveProfessionalWorkerFrag extends Fragment {

    private NUActiveProWorkerAdapter activeReqiureAdapter;
    ...
    public NUActiveProfessionalWorkerFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activeReqiureAdapter = new NUActiveProWorkerAdapter(getActivity(), activeList);
    ...
    private void findCallback() {
        ...
        activeReqiureAdapter.setListener(new NUActiveProWorkerAdapter.ActiveRequireProff() {
            @Override
